        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <Badge
                variant="secondary"
                className="w-fit bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800"
              >
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
                ...
                <span className="text-blue-600 dark:text-blue-400">Trello Clone</span>
              </h1>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border dark:border-gray-700">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Project Board</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      <div className="bg-white dark:bg-gray-800 p-3 rounded border dark:border-gray-600 text-sm dark:text-gray-200">
                        Design new logo
                      </div>
                      <div className="bg-white dark:bg-gray-800 p-3 rounded border dark:border-gray-600 text-sm dark:text-gray-200">
                        Update website
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      <div className="bg-white dark:bg-gray-800 p-3 rounded border dark:border-gray-600 text-sm dark:text-gray-200 truncate">
                        Write documentation
                      </div>
                    </div>
                  </div>
